//################################Snackbar rewuire feield to write correction in cloud ###################




// import 'dart:async';
// import 'package:LactosureConnect/service/models/gethistory.dart';
...
//   const Msettings({super.key, required this.device});
...
//           print(
//             "📥 CHUNK : ${data.map((e) => e.toRadixString(16).padLeft(2, '0')).join(' ').toUpperCase()}",
//           );

//           bleBuffer.addAll(data);

//           print(
//             "📦 BUFFER : ${bleBuffer.map((e) => e.toRadixString(16).padLeft(2, '0')).join(' ').toUpperCase()}",
//           );
...
//       await sendCommand(startCmd);
//       print("✅ START COMMAND SENT");

//       await Future.delayed(const Duration(seconds: 2));

//       print("📝 WRITING FAT & SNF");
...
//       List<int> writeReply = await sendCommandAndWait(
//         calibrationCmd,
//         timeoutSeconds: 5,
...
//       print(
//         "✅ WRITE REPLY RECEIVED : ${writeReply.map((e) => e.toRadixString(16).padLeft(2, '0')).join(' ').toUpperCase()}",
//       );

//       bool success = false;

//       if (writeReply.length >= 3) {
//         if (writeReply[0] == 0x40 && writeReply[1] == 0x04) {
//           if (writeReply[2] == 0x29 || writeReply[2] == 0x35) {
//             success = true;
//           }
//         }
//       }
